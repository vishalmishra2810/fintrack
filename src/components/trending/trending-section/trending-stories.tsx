...
import TrendingNews from "../trendingJson/trending-news.json";
import { TrendingBlogData } from "@/src/response/trending-blog.response";

const TrendingStories = () => {
  return (
    <div className="container mb-24 mt-5 mx-auto md:px-6">
      <section className="mb-32 text-center md:text-left">
        <h2 className="mb-12 text-center text-[20px] font-bold">Trending</h2>

        {TrendingNews.trendingNews.map((data: TrendingBlogData, index: number) => {
